class Jb < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.6/jb-aarch64-apple-darwin.tar.gz"
      sha256 "9ba5041bafd65b3011a57b87e74781d2d85b193fe7b3e28acd6611168e33c4ee"
    end

    on_intel do
      url "https://github.com/nijaru/jb/archive/refs/tags/v0.0.6.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.6/jb-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "94eb18969a04216e325991e7b16af272f1745cbe9b1f615267cfb2bd3fb01c93"
    end

    on_intel do
      url "https://github.com/nijaru/jb/releases/download/v0.0.6/jb-x86_64-unknown-linux-gnu.tar.gz"
