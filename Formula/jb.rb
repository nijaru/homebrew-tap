class Jb < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.11/jb-aarch64-apple-darwin.tar.gz"
      sha256 "6774ace92521669703a2711d3353c23dd3c016a82e4897154eb30dc59aef4d9a"
    end

    on_intel do
      url "https://github.com/nijaru/jb/archive/refs/tags/v0.0.11.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.11/jb-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "30da0550bf59f59262460399bfb587d09047e05ec8771090b1bbcf6bfba57de9"
    end

    on_intel do
      url "https://github.com/nijaru/jb/releases/download/v0.0.11/jb-x86_64-unknown-linux-gnu.tar.gz"
