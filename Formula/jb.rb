class Jb < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.10/jb-aarch64-apple-darwin.tar.gz"
      sha256 "4199a0aa7c820010b2a687a53bb819c09fa819cb8fd7601cac21e8ffed34f301"
    end

    on_intel do
      url "https://github.com/nijaru/jb/archive/refs/tags/v0.0.10.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nijaru/jb/releases/download/v0.0.10/jb-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "3c212cabe9c6b3157c14e7dc19c82a888ebf640c06c999bbdd3d6752a575262d"
    end

    on_intel do
      url "https://github.com/nijaru/jb/releases/download/v0.0.10/jb-x86_64-unknown-linux-gnu.tar.gz"
